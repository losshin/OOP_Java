...
public class Main extends Characteristics{
    static int id = 1;
    // set arrayList
    ...
    private static void create() throws IOException {   
        ...
        characteristics.name = br.readLine();
        ...
        if(characteristics.numberOfWeapon <= 20 && characteristics.radarRange < 20000 && characteristics.bombCapasity <= 6 && characteristics.combatRange <= 10000) {
            aircraft.add(new MilitaryAircraft(characteristics.name, characteristics.countryOfOrigin, characteristics.machineType, "FIGHTER", characteristics.combatRange, characteristics.numberOfWeapon, characteristics.bombCapasity, characteristics.radarRange));
    ...
    private static void read() throws IOException {
        ...
        for(int i = 0; i < aircraft.size(); i++) {
            ...
            System.out.println("Jenis           : " + aircraft.get(i).aircraftType);
            System.out.println("Asal Negara     : " + aircraft.get(i).countryOfOrigin);            
            System.out.println("Jenis Mesin     : " + aircraft.get(i).machineType);            
            System.out.println("Jarak Tempuh    : " + aircraft.get(i).combatRange);            
